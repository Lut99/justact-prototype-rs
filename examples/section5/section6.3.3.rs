...
fn main() {
    ...
    let agents: [Agent; 7] = [
        Amy::new(Script::Section6_3_3, &dataplane).into(),
        Bob::new(Script::Section6_3_3, &dataplane).into(),
        Dan::new(Script::Section6_3_3).into(),
    ...
    let sync = Consortium::new(Script::Section6_3_3);
